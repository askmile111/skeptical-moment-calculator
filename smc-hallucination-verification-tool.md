# Engineering Build Log: Skeptical Moment Calculator (SMC)
...
|---|---|---|
|Keyword‑AND matching may falsely trigger on negated sentences (e.g., “I am _not_ low‑quality”)|False positive|v0.2: add negation detection|
...
- **Source code**: `skeptical_calculator.html` (single file, ~140 lines, with comments)
...
3. Keep the tool open‑source / free; no commercialisation efforts will be pursued.